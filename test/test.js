...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof zxdy, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( zxdy.length, 1, 'has expected arity' );
	t.end();
});

tape( 'the function divides elements of `x` by `y` and assigns the results to `y`', function test( t ) {
	var expected;
	var actual;
	var xbuf;
	var ybuf;
	...
	xbuf = new Complex128Array( [ -1.0, 3.0, -2.0, 14.0, -4.0, 44.0 ] );
	ybuf = new Complex128Array( [ 1.0, 1.0, 2.0, 2.0, 4.0, 4.0 ] );
	x = vector( xbuf, 3, 1, 0 );
	y = vector( ybuf, 3, 1, 0 );
	...
	xbuf = new Complex128Array( [ 6.0, 2.0, -3.0, 1.0 ] );
	ybuf = new Complex128Array( [ 2.0, 2.0, 1.0, 1.0 ] );
	x = vector( xbuf, 2, 1, 0 );
	y = vector( ybuf, 2, 1, 0 );
